...
Success (``True``) inidcates that there was data of the requested block type present at the current step, while failure (``False``) indicates either no data present, file corruption or a file reading excepetion not caught by PyTNG.
