 ...
 *        - Fixed bugs, such as:
 *           - Do not switch endianness when reading and writing TNG compressed
 * data.
 *           - Update pointers to residues in the chain when writing multiple
 * chains in one molecule.
 ...
 *     else
 *     {
 *         printf("Simulation box shape not set in the file (or could not be
 * read)\n");
 *     }
 *
 ...
 *     if(tng_util_pos_read_range(traj, 0, last_frame, &positions,
 * &stride_length)
 *        == TNG_SUCCESS)
 *     {
 ...
 *
 * To compile the fortran example -DTNG_BUILD_FORTRAN=ON needs to be specified
 * when running cmake.
 *
 */
...
typedef enum { TNG_BIG_ENDIAN, TNG_LITTLE_ENDIAN } tng_file_endianness;
...
/** Hash types */
typedef enum { TNG_NO_HASH, TNG_MD5, TNG_SHA256 } tng_hash_type;
...
tng_version_major(tng_trajectory_t tng_data, int *version);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_version_minor(tng_trajectory_t tng_data, int *version);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_version_patchlevel(tng_trajectory_t tng_data, int *patch_level);
 ...
 * @return TNG_SUCCESS (0) if successful.
 */
tng_function_status DECLSPECDLLEXPORT tng_version(tng_trajectory_t tng_data,
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_trajectory_init_from_src(tng_trajectory_t src, tng_trajectory_t *dest_p);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_input_file_get(tng_trajectory_t tng_data, char *file_name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_input_file_set(tng_trajectory_t tng_data, const char *file_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_output_file_get(tng_trajectory_t tng_data, char *file_name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_output_file_set(tng_trajectory_t tng_data, const char *file_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_output_append_file_set(tng_trajectory_t tng_data, const char *file_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_program_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_program_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_program_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_program_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_user_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_user_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_user_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_user_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_computer_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_computer_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_computer_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_computer_name_set(tng_trajectory_t tng_data, const char *new_name);
...
tng_function_status DECLSPECDLLEXPORT tng_first_signature_get(
    tng_trajectory_t tng_data, char *signature, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_first_signature_set(tng_trajectory_t tng_data, const char *signature);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_signature_get(tng_trajectory_t tng_data, char *signature, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_last_signature_set(tng_trajectory_t tng_data, const char *signature);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_forcefield_name_get(tng_trajectory_t tng_data, char *name, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_forcefield_name_set(tng_trajectory_t tng_data, const char *new_name);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_medium_stride_length_get(tng_trajectory_t tng_data, int64_t *len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_medium_stride_length_set(tng_trajectory_t tng_data, int64_t len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_long_stride_length_get(tng_trajectory_t tng_data, int64_t *len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_long_stride_length_set(tng_trajectory_t tng_data, int64_t len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_time_per_frame_get(tng_trajectory_t tng_data, double *time);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_time_per_frame_set(tng_trajectory_t tng_data, double time);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_input_file_len_get(tng_trajectory_t tng_data, int64_t *len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_frames_get(tng_trajectory_t tng_data, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_compression_precision_get(tng_trajectory_t tng_data, double *precision);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_compression_precision_set(tng_trajectory_t tng_data, double precision);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_implicit_num_particles_set(tng_trajectory_t tng_data, int64_t n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_particles_get(tng_trajectory_t tng_data, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_particles_variable_get(tng_trajectory_t tng_data, char *variable);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_molecule_types_get(tng_trajectory_t tng_data, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_molecules_get(tng_trajectory_t tng_data, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_cnt_list_get(tng_trajectory_t tng_data, int64_t **mol_cnt_list);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_distance_unit_exponential_get(tng_trajectory_t tng_data, int64_t *exp);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_distance_unit_exponential_set(tng_trajectory_t tng_data, int64_t exp);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_frames_per_frame_set_get(tng_trajectory_t tng_data, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_frames_per_frame_set_set(tng_trajectory_t tng_data, int64_t n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_num_frame_sets_get(tng_trajectory_t tng_data, int64_t *n);
...
tng_function_status DECLSPECDLLEXPORT tng_current_frame_set_get(
    tng_trajectory_t tng_data, tng_trajectory_frame_set_t *frame_set_p);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_nr_find(tng_trajectory_t tng_data, int64_t nr);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_of_frame_find(tng_trajectory_t tng_data, int64_t frame);
...
tng_function_status DECLSPECDLLEXPORT tng_frame_set_next_frame_set_file_pos_get(
    tng_trajectory_t tng_data, tng_trajectory_frame_set_t frame_set,
    int64_t *pos);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_alloc(tng_trajectory_t tng_data, tng_molecule_t *molecule_p);

/**
 * @brief Clean up a molecule container and free its allocated memory.
 * @param tng_data is a trajectory data container.
 * @param molecule_p is the molecule to destroy.
 * @details All allocated memory in the data structure is freed and also the
 * memory of the molecule itself.
 * @return TNG_SUCCESS (0) if successful or TNG_CRITICAL (2) if a major
 * error has occured.
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_free(tng_trajectory_t tng_data, tng_molecule_t *molecule_p);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_init(tng_trajectory_t tng_data, tng_molecule_t molecule);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_destroy(tng_trajectory_t tng_data, tng_molecule_t molecule);

/**
 * @brief Add a molecule to the trajectory.
 * @param tng_data is the trajectory data container containing the block..
 * @param name is a pointer to the string containing the name of the new
 * molecule.
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_add(
    tng_trajectory_t tng_data, const char *name, tng_molecule_t *molecule);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_w_id_add(tng_trajectory_t tng_data, const char *name, int64_t id,
                      tng_molecule_t *molecule);

/**
 * @brief Add an existing molecule (from a molecule container) to the
 * trajectory.
 * @param tng_data is the trajectory data container containing the block..
 * @param molecule is a pointer to the molecule to add to the trajectory and
 * will afterwards point to the molecule in the trajectory.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_existing_add(tng_trajectory_t tng_data, tng_molecule_t *molecule);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_name_get(tng_trajectory_t tng_data, tng_molecule_t molecule,
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_name_set(
    tng_trajectory_t tng_data, tng_molecule_t molecule, const char *new_name);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_cnt_get(
    tng_trajectory_t tng_data, tng_molecule_t molecule, int64_t *cnt);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_find(tng_trajectory_t tng_data, const char *name, int64_t id,
                  tng_molecule_t *molecule);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_of_index_get(
    tng_trajectory_t tng_data, int64_t index, tng_molecule_t *molecule);
 ...
 * must be initialised before using it.
 * @pre \code tng_data_dest != 0 \endcode The trajectory container
 * (tng_data_dest) must be initialised before using it.
 ...
 */
tng_function_status DECLSPECDLLEXPORT tng_molecule_system_copy(
    tng_trajectory_t tng_data_src, tng_trajectory_t tng_data_dest);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_num_chains_get(
    tng_trajectory_t tng_data, tng_molecule_t molecule, int64_t *n);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_chain_of_index_get(
    tng_trajectory_t tng_data, tng_molecule_t molecule, int64_t index,
    tng_chain_t *chain);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_chain_find(tng_trajectory_t tng_data, tng_molecule_t molecule,
                        const char *name, int64_t id, tng_chain_t *chain);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_chain_add(tng_trajectory_t tng_data, tng_molecule_t molecule,
                       const char *name, tng_chain_t *chain);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_chain_w_id_add(tng_trajectory_t tng_data, tng_molecule_t molecule,
                            const char *name, int64_t id, tng_chain_t *chain);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_bond_add(
    tng_trajectory_t tng_data, tng_molecule_t molecule, int64_t from_atom_id,
    int64_t to_atom_id, tng_bond_t *bond);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molecule_atom_find(tng_trajectory_t tng_data, tng_molecule_t molecule,
                       const char *name, int64_t id, tng_atom_t *atom);
...
tng_function_status DECLSPECDLLEXPORT tng_chain_name_get(
    tng_trajectory_t tng_data, tng_chain_t chain, char *name, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_chain_name_set(
    tng_trajectory_t tng_data, tng_chain_t chain, const char *new_name);
...
tng_function_status DECLSPECDLLEXPORT tng_chain_num_residues_get(
    tng_trajectory_t tng_data, tng_chain_t chain, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_chain_residue_of_index_get(tng_trajectory_t tng_data, tng_chain_t chain,
                               int64_t index, tng_residue_t *residue);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_chain_residue_find(tng_trajectory_t tng_data, tng_chain_t chain,
                       const char *name, int64_t id, tng_residue_t *residue);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_chain_residue_add(tng_trajectory_t tng_data, tng_chain_t chain,
                      const char *name, tng_residue_t *residue);
...
tng_function_status DECLSPECDLLEXPORT tng_chain_residue_w_id_add(
    tng_trajectory_t tng_data, tng_chain_t chain, const char *name, int64_t id,
    tng_residue_t *residue);
...
tng_function_status DECLSPECDLLEXPORT tng_residue_name_get(
    tng_trajectory_t tng_data, tng_residue_t residue, char *name, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_residue_name_set(
    tng_trajectory_t tng_data, tng_residue_t residue, const char *new_name);
...
tng_function_status DECLSPECDLLEXPORT tng_residue_num_atoms_get(
    tng_trajectory_t tng_data, tng_residue_t residue, int64_t *n);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_residue_atom_of_index_get(tng_trajectory_t tng_data, tng_residue_t residue,
                              int64_t index, tng_atom_t *atom);
...
tng_function_status DECLSPECDLLEXPORT tng_residue_atom_add(
    tng_trajectory_t tng_data, tng_residue_t residue, const char *atom_name,
    const char *atom_type, tng_atom_t *atom);
...
tng_function_status DECLSPECDLLEXPORT tng_residue_atom_w_id_add(
    tng_trajectory_t tng_data, tng_residue_t residue, const char *atom_name,
    const char *atom_type, int64_t id, tng_atom_t *atom);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_residue_get(
    tng_trajectory_t tng_data, tng_atom_t atom, tng_residue_t *residue);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_name_get(
    tng_trajectory_t tng_data, tng_atom_t atom, char *name, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_name_set(
    tng_trajectory_t tng_data, tng_atom_t atom, const char *new_name);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_type_get(
    tng_trajectory_t tng_data, tng_atom_t atom, char *type, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_type_set(
    tng_trajectory_t tng_data, tng_atom_t atom, const char *new_type);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_name_of_particle_nr_get(
    tng_trajectory_t tng_data, int64_t nr, char *name, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_molecule_id_of_particle_nr_get(
    tng_trajectory_t tng_data, int64_t nr, int64_t *id);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_molsystem_bonds_get(tng_trajectory_t tng_data, int64_t *n_bonds,
                        int64_t **from_atoms, int64_t **to_atoms);
...
tng_function_status DECLSPECDLLEXPORT tng_atom_type_of_particle_nr_get(
    tng_trajectory_t tng_data, int64_t nr, char *type, int max_len);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_particle_mapping_add(tng_trajectory_t tng_data, int64_t num_first_particle,
                         int64_t n_particles, const int64_t *mapping_table);
 ...
 * @details The trajectory blocks must be read separately and iteratively in
 * chunks to fit in memory.
 * @param tng_data is a trajectory data container.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_file_headers_read(tng_trajectory_t tng_data, char hash_mode);

/**
 * @brief Write the header blocks to the output_file of tng_data.
 * @details The trajectory blocks must be written separately and iteratively in
 * chunks to fit in memory.
 * @param tng_data is a trajectory data container.
 ...
 * will be opened.
 * @param hash_mode is an option to decide whether to use the md5 hash or not.
 * If hash_mode == TNG_USE_HASH an md5 hash for each header block will be
 * generated.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @return TNG_SUCCESS (0) if successful or TNG_CRITICAL (2) if a major
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_file_headers_write(tng_trajectory_t tng_data, char hash_mode);

/**
 * @brief Read one (the next) block (of any kind) from the input_file of
 * tng_data.
 * @param tng_data is a trajectory data container.
 * @details tng_data->input_file_path specifies
 * which file to read from. If the file (input_file) is not open it will be
...
tng_function_status DECLSPECDLLEXPORT tng_block_read_next(
    tng_trajectory_t tng_data, tng_gen_block_t block_data, char hash_mode);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_read(tng_trajectory_t tng_data, char hash_mode);
...
/**
 * @brief Read one (the next) frame set, including particle mapping and related
 * data blocks from the input_file of tng_data.
 * @param tng_data is a trajectory data container.
 * @details  tng_data->input_file_path specifies
 * which file to read from. If the file (input_file) is not open it will be
 * opened.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_read_next(tng_trajectory_t tng_data, char hash_mode);

/**
 * @brief Read one (the next) frame set, including particle mapping and data
 * blocks with a specific block id from the input_file of tng_data.
 * @param tng_data is a trajectory data container.
 * @details  tng_data->input_file_path specifies
 * which file to read from. If the file (input_file) is not open it will be
 * opened.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_read_next_only_data_from_block_id(tng_trajectory_t tng_data,
                                                char hash_mode,
                                                int64_t block_id);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_write(tng_trajectory_t tng_data, char hash_mode);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_premature_write(tng_trajectory_t tng_data, char hash_mode);

/**
 * @brief Create and initialise a frame set.
 * @details Particle mappings are retained from previous frame set (if any).
 * To explicitly clear particle mappings use
...
tng_function_status DECLSPECDLLEXPORT tng_frame_set_new(
    tng_trajectory_t tng_data, int64_t first_frame, int64_t n_frames);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_set_with_time_new(tng_trajectory_t tng_data, int64_t first_frame,
                            int64_t n_frames, double first_frame_time);
...
tng_function_status DECLSPECDLLEXPORT tng_frame_set_first_frame_time_set(
    tng_trajectory_t tng_data, double first_frame_time);
...
tng_function_status DECLSPECDLLEXPORT tng_first_frame_nr_of_next_frame_set_get(
    tng_trajectory_t tng_data, int64_t *frame);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_data_block_add(tng_trajectory_t tng_data, int64_t id,
                   const char *block_name, char datatype, char block_type_flag,
                   int64_t n_frames, int64_t n_values_per_frame,
                   int64_t stride_length, int64_t codec_id, void *new_data);
...
tng_function_status DECLSPECDLLEXPORT tng_particle_data_block_add(
    tng_trajectory_t tng_data, int64_t id, const char *block_name,
    char datatype, char block_type_flag, int64_t n_frames,
    int64_t n_values_per_frame, int64_t stride_length,
    int64_t num_first_particle, int64_t n_particles, int64_t codec_id,
    void *new_data);
...
tng_function_status DECLSPECDLLEXPORT tng_data_block_name_get(
    tng_trajectory_t tng_data, int64_t block_id, char *name, int max_len);
...
tng_function_status DECLSPECDLLEXPORT tng_data_block_dependency_get(
    tng_trajectory_t tng_data, int64_t block_id, int *block_dependency);
...
tng_function_status DECLSPECDLLEXPORT tng_data_block_num_values_per_frame_get(
    tng_trajectory_t tng_data, int64_t block_id, int64_t *n_values_per_frame);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_frame_data_write(tng_trajectory_t tng_data, int64_t frame_nr,
                     int64_t block_id, const void *values, char hash_mode);
 ...
 * first particle must be >= 0.
 * @pre \code val_n_particles >= 0 \endcode The number of particles must be >=
 * 0.
 * @pre \code values != 0 \endcode The pointer to the values must not be a NULL
 * pointer.
 * @return TNG_SUCCESS (0) if successful, TNG_FAILURE (1) if a minor error
...
tng_function_status DECLSPECDLLEXPORT tng_frame_particle_data_write(
    tng_trajectory_t tng_data, int64_t frame_nr, int64_t block_id,
    int64_t val_first_particle, int64_t val_n_particles, const void *values,
    char hash_mode);
 ...
 * @param n_values_per_frame is the number of values per frame in the data
 * array.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_data_values_free(tng_trajectory_t tng_data, union data_values **values,
                     int64_t n_frames, int64_t n_values_per_frame, char type);
...
tng_function_status DECLSPECDLLEXPORT tng_particle_data_values_free(
    tng_trajectory_t tng_data, union data_values ***values, int64_t n_frames,
    int64_t n_particles, int64_t n_values_per_frame, char type);
 ...
 * @param values is a pointer to a 2-dimensional array (memory unallocated),
 * which will be filled with data. The array will be sized (n_frames *
 * n_values_per_frame). Since ***values is allocated in this function it is the
 ...
 * @param n_values_per_frame is set to the number of values per frame in the
 * data. This is needed to properly reach and/or free the data afterwards.
...
tng_function_status DECLSPECDLLEXPORT tng_data_get(
    tng_trajectory_t tng_data, int64_t block_id, union data_values ***values,
    int64_t *n_frames, int64_t *n_values_per_frame, char *type);

/**
 * @brief Retrieve a vector (1D array) of non-particle data, from the last read
 * frame set.
 * @param tng_data is a trajectory data container. tng_data->input_file_path
 * specifies which file to read from. If the file (input_file) is not open it
 * will be opened.
 * @param block_id is the id number of the particle data block to read.
 * @param values is a pointer to a 1-dimensional array (memory unallocated),
 * which will be filled with data. The length of the array will be
 ...
 * @param n_frames is set to the number of particles in the returned data. This
 * is needed to properly reach and/or free the data afterwards.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_data_vector_get(tng_trajectory_t tng_data, int64_t block_id, void **values,
                    int64_t *n_frames, int64_t *stride_length,
                    int64_t *n_values_per_frame, char *type);
 ...
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @pre \code start_frame_nr <= end_frame_nr \endcode The first frame must be
...
tng_function_status DECLSPECDLLEXPORT tng_data_interval_get(
    tng_trajectory_t tng_data, int64_t block_id, int64_t start_frame_nr,
    int64_t end_frame_nr, char hash_mode, union data_values ***values,
    int64_t *n_values_per_frame, char *type);
...
tng_function_status DECLSPECDLLEXPORT tng_data_vector_interval_get(
    tng_trajectory_t tng_data, int64_t block_id, int64_t start_frame_nr,
    int64_t end_frame_nr, char hash_mode, void **values, int64_t *stride_length,
    int64_t *n_values_per_frame, char *type);
 ...
 * will be opened.
 * @param block_id is the id number of the particle data block to read.
 * @param values is a pointer to a 3-dimensional array (memory unallocated),
 * which will be filled with data. The array will be sized (n_frames *
 * n_particles * n_values_per_frame). Since ****values is allocated in this
 * function it is the callers responsibility to free the memory.
 * @param n_frames is set to the number of frames in the returned data. This is
 * needed to properly reach and/or free the data afterwards.
 * @param n_particles is set to the number of particles in the returned data.
 ...
 * @pre \code n_frames != 0 \endcode The pointer to the number of frames
 * must not be a NULL pointer.
 * @pre \code n_particles != 0 \endcode The pointer to the number of particles
 * must not be a NULL pointer.
 * @pre \code n_values_per_frame != 0 \endcode The pointer to the number of
 * values per frame must not be a NULL pointer.
 * @pre \code type != 0 \endcode The pointer to the data type must not
...
tng_function_status DECLSPECDLLEXPORT tng_particle_data_get(
    tng_trajectory_t tng_data, int64_t block_id, union data_values ****values,
    int64_t *n_frames, int64_t *n_particles, int64_t *n_values_per_frame,
    char *type);

/**
 * @brief Retrieve a vector (1D array) of particle data, from the last read
 * frame set.
 * @details The particle dimension of the returned values array is translated
 * to real particle numbering, i.e. the numbering of the actual molecular
 * system.
...
tng_function_status DECLSPECDLLEXPORT tng_particle_data_vector_get(
    tng_trajectory_t tng_data, int64_t block_id, void **values,
    int64_t *n_frames, int64_t *stride_length, int64_t *n_particles,
    int64_t *n_values_per_frame, char *type);
...
tng_function_status DECLSPECDLLEXPORT tng_particle_data_vector_interval_get(
    tng_trajectory_t tng_data, int64_t block_id, int64_t start_frame_nr,
    int64_t end_frame_nr, char hash_mode, void **values, int64_t *n_particles,
    int64_t *stride_length, int64_t *n_values_per_frame, char *type);

/**
 * @brief Get the stride length of a specific data (particle dependency does not
 * matter) block, either in the current frame set or of a specific frame.
 * @param tng_data is the trajectory data container.
 * @param block_id is the block ID of the data block, of which to retrieve the
 * stride length of the data.
 * @param frame is the frame from which to get the stride length. If frame is
 * set to -1 no specific frame will be used, but instead the first frame,
 * starting from the last read frame set, containing the data block will be
 * used.
 * @param stride_length is set to the value of the stride length of the data
 * block.
 * @return  TNG_SUCCESS (0) if successful, TNG_FAILURE (1) if a minor error
 * has occurred or TNG_CRITICAL (2) if a major error has occured.
 */
tng_function_status DECLSPECDLLEXPORT
tng_data_get_stride_length(tng_trajectory_t tng_data, int64_t block_id,
                           int64_t frame, int64_t *stride_length);

/**
 * @brief Get the date and time of initial file creation in ISO format (string).
 * @param tng_data is a trajectory data container.
 * @param time is a pointer to the string in which the date will be stored.
 * Memory must be reserved beforehand.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_time_get_str(tng_trajectory_t tng_data, char *time);
/** @} */ /* end of group1 */
...
tng_function_status DECLSPECDLLEXPORT tng_util_trajectory_open(
    const char *filename, char mode, tng_trajectory_t *tng_data_p);
...
tng_function_status DECLSPECDLLEXPORT tng_util_time_of_frame_get(
    tng_trajectory_t tng_data, int64_t frame_nr, double *time);
...
tng_function_status DECLSPECDLLEXPORT tng_util_pos_read(
    tng_trajectory_t tng_data, float **positions, int64_t *stride_length);
...
tng_function_status DECLSPECDLLEXPORT tng_util_vel_read(
    tng_trajectory_t tng_data, float **velocities, int64_t *stride_length);
...
tng_function_status DECLSPECDLLEXPORT tng_util_force_read(
    tng_trajectory_t tng_data, float **forces, int64_t *stride_length);
 ...
 * of frames. The variable may point at already allocated memory or be a NULL
 * pointer. If the box shape is not modified during the trajectory, but as
 * general data, that will be returned instead.
 * @param stride_length will be set to the writing interval of the stored data.
 * @details This function should only be used if number of values used to
 * specify the box shape is known (by default TNG uses 9 values) since it does
 * not return the number of values in the array. It is recommended to use
 * tng_data_vector_interval_get() instead.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
...
tng_function_status DECLSPECDLLEXPORT tng_util_box_shape_read(
    tng_trajectory_t tng_data, float **box_shape, int64_t *stride_length);
 ...
 * requested data. The variable may point at already allocated memory (which
 * will be reallocated with realloc()), or be a NULL pointer. The calling code
 * must free the memory afterwards.
 * @param data_type will be pointing to a character indicating the size of the
 * data of the returned values, e.g. TNG_INT_DATA, TNG_FLOAT_DATA or
 * TNG_DOUBLE_DATA.
...
tng_function_status DECLSPECDLLEXPORT tng_util_particle_data_next_frame_read(
    tng_trajectory_t tng_data, int64_t block_id, void **values, char *data_type,
    int64_t *retrieved_frame_number, double *retrieved_time);

/**
 * @brief High-level function for reading the next frame of
 * non-particle-dependent data of a specific type.
 * @param tng_data is the trajectory to read from.
 * @param block_id is the ID number of the block containing the data of
 * interest.
 * @param values will be set to point at a 1-dimensional array containing the
...
tng_function_status DECLSPECDLLEXPORT tng_util_pos_read_range(
    tng_trajectory_t tng_data, int64_t first_frame, int64_t last_frame,
...
tng_function_status DECLSPECDLLEXPORT tng_util_box_shape_read_range(
    tng_trajectory_t tng_data, int64_t first_frame, int64_t last_frame,
    float **box_shape, int64_t *stride_length);
...
tng_function_status DECLSPECDLLEXPORT tng_util_generic_write_interval_set(
    tng_trajectory_t tng_data, int64_t i, int64_t n_values_per_frame,
    int64_t block_id, const char *block_name, char particle_dependency,
    char compression);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_generic_write_interval_double_set(tng_trajectory_t tng_data, int64_t i,
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_pos_write_interval_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_pos_write_interval_double_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_pos_write_frequency_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_vel_write_interval_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_vel_write_interval_double_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_vel_write_frequency_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_force_write_interval_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_force_write_interval_double_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_force_write_frequency_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_box_shape_write_interval_set(tng_trajectory_t tng_data, int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_box_shape_write_interval_double_set(tng_trajectory_t tng_data,
                                             int64_t i);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_box_shape_write_frequency_set(tng_trajectory_t tng_data, int64_t i);
...
tng_function_status DECLSPECDLLEXPORT tng_util_generic_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const float *values,
    int64_t n_values_per_frame, int64_t block_id, const char *block_name,
    char particle_dependency, char compression);

/**
 * @brief High-level function for writing data of one frame to a double
...
tng_function_status DECLSPECDLLEXPORT tng_util_generic_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const double *values,
    int64_t n_values_per_frame, int64_t block_id, const char *block_name,
    char particle_dependency, char compression);
 ...
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @pre \code positions != 0 \endcode The pointer to the positions array must
 * not be a NULL pointer.
...
tng_function_status DECLSPECDLLEXPORT tng_util_pos_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const float *positions);
...
tng_function_status DECLSPECDLLEXPORT tng_util_pos_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const double *positions);
 ...
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @pre \code velocities != 0 \endcode The pointer to the velocities array must
 * not be a NULL pointer.
 * @details This function uses tng_util_generic_write() and will
...
tng_function_status DECLSPECDLLEXPORT tng_util_vel_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const float *velocities);
...
tng_function_status DECLSPECDLLEXPORT tng_util_vel_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const double *velocities);
...
tng_function_status DECLSPECDLLEXPORT tng_util_force_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const float *forces);
...
tng_function_status DECLSPECDLLEXPORT tng_util_force_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const double *forces);
 ...
 * @param frame_nr is the frame number of the data. If frame_nr < 0 the
 * data is written as non-trajectory data.
 * @param box_shape is a 1D array of data to add. The array should be of
 * length 9.
 * @pre \code tng_data != 0 \endcode The trajectory container (tng_data)
 * must be initialised before using it.
 * @pre \code box_shape != 0 \endcode The pointer to the box_shape array must
 * not be a NULL pointer.
 * @details This function uses tng_util_generic_write() and will
...
tng_function_status DECLSPECDLLEXPORT tng_util_box_shape_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const float *box_shape);
...
tng_function_status DECLSPECDLLEXPORT tng_util_box_shape_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, const double *box_shape);
...
tng_function_status DECLSPECDLLEXPORT tng_util_generic_with_time_write(
    tng_trajectory_t tng_data, int64_t frame_nr, double time,
    const float *values, int64_t n_values_per_frame, int64_t block_id,
    const char *block_name, char particle_dependency, char compression);

/**
 * @brief High-level function for writing data of one frame to a double
 * precision data block. If the frame is at the beginning of a frame set the
...
tng_function_status DECLSPECDLLEXPORT tng_util_generic_with_time_double_write(
    tng_trajectory_t tng_data, int64_t frame_nr, double time,
    const double *values, int64_t n_values_per_frame, int64_t block_id,
    const char *block_name, char particle_dependency, char compression);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_pos_with_time_write(tng_trajectory_t tng_data, int64_t frame_nr,
                             double time, const float *positions);
 ...
 * @pre \code positions != 0 \endcode The pointer to the positions array must
 * not be a NULL pointer.
 * @details This function uses tng_util_generic_with_time_double_write() and
 * will create a positions data block if none exists. Positions are stored as
 * three values per frame and compressed using TNG compression. N.b. Since
 * compressed data is written a whole block at a time the data is not actually
 * written to disk until the frame set is finished or the TNG trajectory is
 * closed.
 * @return TNG_SUCCESS (0) if successful, TNG_FAILURE (1) if a minor error
 * has occured or TNG_CRITICAL (2) if a major error has occured.
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_pos_with_time_double_write(tng_trajectory_t tng_data, int64_t frame_nr,
                                    double time, const double *positions);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_vel_with_time_write(tng_trajectory_t tng_data, int64_t frame_nr,
                             double time, const float *velocities);
 ...
 * not be a NULL pointer.
 * @details This function uses tng_util_generic_with_time_double_write() and
 * will create a velocities data block if none exists. Velocities are stored as
 * three values per frame and compressed using TNG compression. N.b. Since
 * compressed data is written a whole block at a time the data is not actually
 * written to disk until the frame set is finished or the TNG trajectory is
 * closed.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_vel_with_time_double_write(tng_trajectory_t tng_data, int64_t frame_nr,
                                    double time, const double *velocities);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_force_with_time_write(tng_trajectory_t tng_data, int64_t frame_nr,
                               double time, const float *forces);
 ...
 * be a NULL pointer.
 * @details This function uses tng_util_generic_with_time_double_write() and
 * will create a forces data block if none exists. Forces are stored as three
 * values per frame and compressed using gzip compression.
 * N.b. Since compressed data is written a whole block at a time the data is not
 * actually written to disk until the frame set is finished or the TNG
 * trajectory is closed.
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_box_shape_with_time_write(tng_trajectory_t tng_data, int64_t frame_nr,
                                   double time, const float *box_shape);
 ...
 * not be a NULL pointer.
 * @details This function uses tng_util_generic_with_time_double_write() and
 * will create a box shape data block if none exists. Box shapes are stored as 9
 * values per frame and compressed using TNG compression.
 * N.b. Since compressed data is written a whole block at a time the data is not
 * actually written to disk until the frame set is finished or the TNG
 * trajectory is closed.
 ...
 * @return TNG_SUCCESS (0) if successful, TNG_FAILURE (1) if a minor error
 * has occured (such as the block_id not found) or TNG_CRITICAL (2) if a major
 * error has occured.
 */
tng_function_status DECLSPECDLLEXPORT tng_util_frame_current_compression_get(
    tng_trajectory_t tng_data, int64_t block_id, int64_t *codec_id,
    double *factor);
 ...
 * @pre \code n_requested_data_block_ids == 0 || requested_data_block_ids != 0
 * \endcode If the number of requested data blocks != 0 then the array of data
 * block IDs must not be NULL.
 * @return TNG_SUCCESS (0) if successful, TNG_FAILURE (1) if a minor error
 * has occured (such as no next frame found) or TNG_CRITICAL (2) if a major
 * error has occured.
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_trajectory_next_frame_present_data_blocks_find(
    tng_trajectory_t tng_data, int64_t current_frame,
    int64_t n_requested_data_block_ids, const int64_t *requested_data_block_ids,
    int64_t *next_frame, int64_t *n_data_blocks_in_next_frame,
    int64_t **data_block_ids_in_next_frame);

/** @brief Finds the frame set of the specified frame in order to prepare for
 * writing after it.
 * @param tng_data is the trajectory to use.
...
tng_function_status DECLSPECDLLEXPORT tng_util_prepare_append_after_frame(
    tng_trajectory_t tng_data, int64_t prev_frame);
 ...
 */
tng_function_status DECLSPECDLLEXPORT
tng_util_num_frames_with_data_of_block_id_get(tng_trajectory_t tng_data,
                                              int64_t block_id,
                                              int64_t *n_frames);
/** @} */ /* end of group2 */
...
struct tng_data {
  ...
  char datatype;
  /** A flag to indicate if this data block contains frame and/or particle
   * dependent data */
  char dependency;
...
struct tng_trajectory {
   ...
   * input file */
  tng_function_status (*input_endianness_swap_func_32)(
      const struct tng_trajectory *, uint32_t *);
  /** Function to swap 64 bit values to and from the endianness of the
   * input file */
  tng_function_status (*input_endianness_swap_func_64)(
      const struct tng_trajectory *, uint64_t *);
  /** Function to swap 32 bit values to and from the endianness of the
   * input file */
  tng_function_status (*output_endianness_swap_func_32)(
      const struct tng_trajectory *, uint32_t *);
  /** Function to swap 64 bit values to and from the endianness of the
   * input file */
  tng_function_status (*output_endianness_swap_func_64)(
      const struct tng_trajectory *, uint64_t *);
...
tng_function_status tng_block_header_read(struct tng_trajectory *tng_data,
...
tng_function_status DECLSPECDLLEXPORT tng_data_get_stride_length(
    struct tng_trajectory *tng_data, const int64_t block_id, int64_t frame,
    int64_t *stride_length);

tng_function_status tng_util_trajectory_next_frame_present_data_blocks_find(
    struct tng_trajectory *tng_data, int64_t current_frame,
    const int64_t n_requested_data_block_ids,
    const int64_t *requested_data_block_ids, int64_t *next_frame,
